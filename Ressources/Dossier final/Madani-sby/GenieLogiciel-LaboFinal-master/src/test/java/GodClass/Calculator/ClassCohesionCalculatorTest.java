 ...
 * @author Sebastien
 */
public class ClassCohesionCalculatorTest
{    
    private static ClassCohesionCalculator instance;
    private static int expectedSize;
    
    public ClassCohesionCalculatorTest()
    {
    }
    ...
    {
        // Ajout des variables
        instance = new ClassCohesionCalculator();
        expectedSize = 6;
